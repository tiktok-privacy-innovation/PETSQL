...
class Data:
    ...
    def __init__(self, data, data_type: "DataType", schema: "Schema") -> None:
        self.data = data
...
class PlainMemoryData(Data):
    ...
    def __init__(self, data: pd.DataFrame, schema: "Schema") -> None:
        super().__init__(data, DataType.PLAIN_MEMORY, schema)
...
class PlainBigData(Data):
    ...
    def __init__(self, data: str, schema: "Schema") -> None:
        super().__init__(data, DataType.PLAIN_BIG_DATA, schema)
...
class MPCDuetData(Data):
    ...
    def __init__(self, data: Dict[str, SecureArray], schema: "Schema") -> None:
        super().__init__(data, DataType.MPC_DUET, schema)
